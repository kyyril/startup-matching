...
import { 
  HeartIcon, Share2Icon, TargetIcon, CalendarIcon, Banknote 
} from 'lucide-react';
...
// Define Project type (adjust based on your actual data structure)
type Project = {
  id: string;
  name: string;
...
export const ProjectDetailClient = ({project}:{project:Project}) => {
  ...
  useEffect(() => {
    ...
    // Or check localStorage for bookmark status
  ...
  const handleBookmark = () => {
    ...
    if (newStatus) {
      ...
      bookmarks = bookmarks.filter((id: string) => id !== project.id);
    }
    ...
    toast({
      ...
      description: newStatus ? "Project saved to your bookmarks" : "Project removed from your saved items",
    });
  };
